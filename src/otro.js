  ...
  C = () =>
    new Promise((e) => {
      ...
      new MutationObserver((r, o) => {
        ...
        d && d.children.length > 0 && (o.disconnect(), e());
...
var Y = () => {
  ...
  P = (() => {
    ...
    return () => {
      ...
      Y();
      let o = (a) =>
          s.has(a) ? !0 : (s.add(a), setTimeout(() => s.delete(a), 5e3), !1),
        d = (a) => {
          let T = r(a);
          if (o(T)) return;
          let i = t(a);
...
function A(e, t = {}, s = new WeakMap(), r = "root") {
  ...
  if (e === void 0) return new y("undefined", "undefined");
  ...
  if (typeof e == "number")
    return Number.isNaN(e)
      ...
      : Number.isFinite(e)
      ? e
      : new y("Number", e > 0 ? "Infinity" : "-Infinity");
  if (typeof e == "boolean") return e;
  if (typeof e == "bigint") return new y("BigInt", e.toString());
  if (typeof e == "symbol") return new y("Symbol", e.toString());
  ...
  if (e && typeof e == "object") {
    if (s.has(e)) return new v(s.get(e));
    s.set(e, r);
  }
  if (e instanceof Error) {
    let i = { name: e.name, message: e.message, stack: e.stack };
  ...
  if (e instanceof Promise) return new y("Promise", "[Promise]");
  ...
  if (e instanceof Set) {
    ...
    return i.length > o.maxArrayLength
      ...
      : new y("Set", { values: i.map((E, b) => A(E, o, s, `${r}.Set[${b}]`)) });
  }
  if (e instanceof Map) {
    let i = {},
      E = 0,
  ...
  if (Array.isArray(e))
    return e.length > o.maxArrayLength
      ...
      : e.map((i, E) => A(i, o, s, `${r}[${E}]`));
  let d = {},
    a = [...Object.getOwnPropertyNames(e)];
  o.includeSymbols &&
    a.push(...Object.getOwnPropertySymbols(e).map((i) => i.toString()));
  let T = 0;
  return (
...
var X = { log: console.log, warn: console.warn, error: console.error },
...
var Q = (e) => {
  ...
  $ = async () => {
    await H();
    let e = Q(document.querySelector("#root"));
    f({ type: "COMPONENT_TREE", payload: { tree: e } });
  };
var F = () => {
  ...
  R = (e) => {
    let t = e.getAttribute("data-lov-id") || "",
      ...
      T = Array.from(e.children)
        .filter((i) => N(i) && L(i).filePath !== s)
        .filter(
          (i, E, b) => E === b.findIndex((O) => L(O).filePath === L(i).filePath)
        )
        .map((i) => ({
    ...
    let r = () => {
      ...
      o = (n) => {
        if (!(!t.tooltip || !n))
          try {
            ...
            if (((t.tooltip.style.maxWidth = `${c.MAX_TOOLTIP_WIDTH}px`), l))
      ...
      i = s((n) => {
        if (
          ...
          return;
        t.hoveredElement &&
          w(L(t.hoveredElement)).forEach((l) => {
      ...
      E = s(() => {
        t.isActive &&
          (t.hoveredElement &&
            ((t.hoveredElement && w(L(t.hoveredElement)))?.forEach((u) => {
      ...
      x = () => {
        document.removeEventListener("mouseover", i),
          ...
          t.hoveredElement &&
            (t.hoveredElement.hasAttribute(c.SELECTED_ATTR) ||
              a(t.hoveredElement),
            (t.hoveredElement = null)),
          b();
      },
      ...
      j = (n) => {
        try {
          ...
          switch (n.data.type) {
            ...
            case "EDIT_TEXT_REQUESTED": {
              ...
              w({ filePath: l.path, lineNumber: l.line }).forEach((m) => {
                ...
                m.addEventListener("input", h), m.addEventListener("blur", _);
              });
              break;
            }
          ...
          console.error("Error handling message:", u), x(), t.reset();
        }
      },
      B = (n) => {
...
var Z = () => {
  if (window.location.search.includes("lov-override-script")) {
    ...
    (t.type = "module"), (t.src = e), document.body.appendChild(t);
    return;
  }
  window.top !== window.self && (M(), P(), k(), G());
};
Z();
