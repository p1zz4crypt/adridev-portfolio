    ...
    const skills = [
        {
            ...
            description: "Interfaces modernas, responsivas y de alto rendimiento. Componentes reutilizables, arquitectura escalable y experiencias de usuario fluidas con React, Vue y JavaScript.",
            image: Ruby,
        ...
        },
        {
            ...
            images: [
                {
                    url: Maxii, // Reemplazar con imagen real del marketplace
                ...
                {
                    url: Maxii, // Reemplazar con capturas de integraciones
