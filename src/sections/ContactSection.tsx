...
const ContactSection: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="bg-gradient-section-6 dark:bg-gradient-section-6-dark py-24 relative"
    >
 ...
 <div className="flex gap-6 w-1/2 p-2" style={{borderLeft: "3px solid black"}}>
            <a
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">CDMX</p>
                </div>
              </motion.div>
            </div>
